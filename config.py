...
SUBSCRIPTION_PLANS = {
    'trial': {
        ...
        'price': 0,
        'days': 7,
        'description': 'Бесплатный тариф для знакомства с функционалом',
        'limits': {
            'accounts': 1,
            'mailings_per_day': 2,
            'messages_per_mailing': 30
        },
        'features': [
            '✅ 1 аккаунт',
            '✅ 2 рассылки в день',
    ...
    'basic': {
        ...
        'price': 490,
        'days': 30,
        'description': 'Оптимальный выбор для небольших рассылок',
        'limits': {
            'accounts': 3,
            'mailings_per_day': 10,
            'messages_per_mailing': 200
        },
        'features': [
            '✅ 3 аккаунта',
            '✅ 10 рассылок в день',
    ...
    'pro': {
        ...
        'price': 1990,
        'days': 30,
        'description': 'Для активных пользователей и бизнеса',
        'limits': {
            'accounts': 10,
            'mailings_per_day': 50,
            'messages_per_mailing': 1000
        },
        'features': [
            '✅ 10 аккаунтов',
            '✅ 50 рассылок в день',
